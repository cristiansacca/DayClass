...
$consulta1 = $con->query("SELECT `legajoUsuario`,`apellidoUsuario`,`nombreUsuario`,`dniUsuario`,`emailUsuario`, `fechaNacimientoUsuario`, `id` FROM `usuario` WHERE id = '$id_usuario'");
...
<div class="container">
  ...
  <div class=" m-auto ">
    <form method="post" id="editarusuario" name="editarusuario" action="actualizarDatosUsuario.php" onsubmit="return validarRepeticion()" enctype="multipart/form-data" role="form">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="number" readonly class="form-control" id="inputDNI" name="inputDNI"
              placeholder="Documento Nacional de Identidad" required <?php echo "value='".$_SESSION["usuario"]["dniUsuario"]."'"; ?>>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="email" class="form-control" id="inputEmailNew" name="inputEmailNew" placeholder="Email" onchange="validarEmail()"
              required <?php echo "value='".$_SESSION["usuario"]["emailUsuario"]."'"; ?>>
