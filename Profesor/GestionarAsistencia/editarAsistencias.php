        ...
        $.ajax({
            ...
            success: function(datosRecibidos) {
                ...
                if(json.actualizados > 0){
                    location.href = '/DayClass/Profesor/GestionarAsistencia/gestionarAsistencia.php?resultado=3';
                } else {
                    location.href = '/DayClass/Profesor/GestionarAsistencia/gestionarAsistencia.php?resultado=4';
                }
