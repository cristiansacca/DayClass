  ...
  <form action="#">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-6 my-2">
        ...
        <div class="my-2">
          ...
          <div class="form-group" id="materias">
            <div>
              <input type="checkbox" name="materia"><label class="m-2">Materia 1</label>
            </div>
            <div>
              <input type="checkbox" name="materia"><label class="m-2">Materia 2</label>
            </div>
            <div>
              <input type="checkbox" name="materia"><label class="m-2">Materia 3</label>
            </div>
            <div>
              <input type="checkbox" name="materia"><label class="m-2">Materia 4</label>
            </div>
            <div>
              <input type="checkbox" name="materia"><label class="m-2">Materia 5</label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container mb-2">
        <button type="submit" id="btnCargar" class="btn btn-primary" onsubmit="return validarCampos();"><i class="fa fa-upload pr-1"></i>Cargar</button>
      </div>
    </div>
  </form>
  <div class="my-2">
      ...
      <div class="modal-body">
        <div class=" text-center my-3 mx-4 form-row">
          <div class="form-group col-12 ">
            ...
            <input type="text" class="form-control m-auto text-center"
              style="width: 230px; font-size: large; border-width: 4px;" id="inputCodigoIngresado"
            ...
            <input type="button" class="btn btn-lg btn-secondary my-3" value="Dar Presente"
              style=" background-color: mediumpurple; border-color: mediumpurple" id="btnVerificarCodIngresado"
              onclick="validarLongCodIngresado()">
          </div>
        </div>
      </div>
