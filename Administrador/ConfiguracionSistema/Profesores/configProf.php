...
<div class="container">
    <div class="jumbotron my-4 py-4">
        ...
        <h1>Profesores<i class="fa fa-user-graduate ml-2"></i></h1>
    ...
    <div class="my-3">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#staticBackdrop1"><i class="fa fa-download mr-1"></i>Importar lista</button>
    </div>
        ...
        ?>
                ...
                <div class="modal-body" <?php 
                    ...
                    <div class="my-2" <?php 
                        ...
                        <input type="text" name="inputLegajo" id="inputLegajo" class="form-control" onchange="validarLegajo()" onkeydown="return event.keyCode !== 109 && event.keyCode !== 107 && event.keyCode !== 110" placeholder="Legajo">
