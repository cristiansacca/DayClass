    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <form method="POST" id="insertAdmin" name="insertAdmin" action="insertAdmin.php" enctype="multipart/form-data" role="form" onsubmit="return validarA()">
                ...
                <div class="modal-body" <?php if ($dni == null) {
                                            echo "hidden ";
                                        } ?>>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6" <?php if ($dni) {
                                                                echo "hidden ";
                                                            } else {
                                                                echo "required ";
                                                            } ?>>
                            <label for="inputLegajo">Legajo</label>
                            <input type="text" class="form-control" id="inputLegajo" name="inputLegajo" placeholder="Legajo" onchange="validarLegajoA()" onkeydown="return event.keyCode !== 109 && event.keyCode !== 107 && event.keyCode !== 110">
