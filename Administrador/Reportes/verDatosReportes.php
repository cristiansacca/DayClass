...
function planillaAlumno($id_curso, $id_alumno, $fechaDesde, $fechaHasta)
{
    ...
    $pdf->Write(10, "Fecha del reporte: $fechaArchivo");
    ...
    $pdf->Ln(5);
    $pdf->Write(6, "Periodo seleccionado: $fechaDesdeReporte - $fechaHastaReporte");
...
function planillaCurso($id_curso, $fechaDesde, $fechaHasta)
{
    ...
    $pdf->Write(10, "Fecha del reporte: $currentDateTime");
    $pdf->Ln(7);
    $pdf->SetFont('Arial', '', 12);
    $pdf->Write(6, "Curso: $nombreCurso");
    $pdf->Ln(5);
...
function planillaMateria($id_materia, $fechaDesde, $fechaHasta){
    ...
    $pdf->Write(10, "Fecha del reporte: $fechaArchivo");
    $pdf->Ln(7);
    $pdf->Write(6, "Materia: $nombreMateria");
    $pdf->Ln(5);
    $pdf->Write(6, "Nivel: $nivelMateria");
    $pdf->Ln(5);
    $pdf->Write(6, "Cantidad de cursos de la materia: $cantCursosMateria");
    $pdf->Ln(5);
    $pdf->Write(6, "Periodo seleccionado: $fechaDesdeReporteC - $fechaHastaReporteC");
...
function planillaInstitucion($fechaDesde, $fechaHasta){
    ...
    $reportName = utf8_decode("Reporte de asistencias de la institución.");
    $reportNameYPos = 160;
